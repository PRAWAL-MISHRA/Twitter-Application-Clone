...
public class UserService {
	...
	public static final String BAD_CREDS = "Bad Credentials";
	public static final String SUCCESS = "Successful Login";
	public static final String DUPLICATE_USER = "Duplicate User";
	public static final String USER_ADDED = "User Created Successfully";
	public static final String PASSWORD_CHANGE_SUCCESS = "Password Changed Successfully";
	public static final String NEW_AND_CONFIRM_PASSWORD_MISMATCH = "New Password and Confirm New Password did not match.";
	public static final String PASSWORD_AND_CONFIRM_PASSWORD_MISMATCH = "Password and Confirm Password did not match.";
	public static final String OLD_PASSWORD_WRONG = "Old Password is incorrect.";
	public static final String SAME_NEW_PASSWORD_AND_OLD_PASSWORD = "New Password cannot be same as Old Password.";
