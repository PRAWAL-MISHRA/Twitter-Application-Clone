...
public class TweetController {
	...
	@PostMapping("/update-tweet")
	public ResponseEntity<String> update(@RequestBody TweetTo tweet) {
		String response = tweetService.updateTweet(tweet);
		return new ResponseEntity<>(response, HttpStatus.OK);
	}

	@PostMapping("/delete-tweet")
	public ResponseEntity<String> delete(@RequestBody TweetTo tweet) {
		String response = tweetService.deleteTweet(tweet);
		return new ResponseEntity<>(response, HttpStatus.OK);
	}
